...
class TestUserModel(BaseTests):
    ...
    def test_password_setter(self):
        u = User('test@gmail.com', 'test1234', (Database.user_count() + 1))
    ...
    def test_password_salts_are_random(self):
        u1 = User('test1@gmail.com', 'test1234', (Database.user_count() + 1))
        u2 = User('test2@gmail.com', 'test1234', (Database.user_count() + 1))
